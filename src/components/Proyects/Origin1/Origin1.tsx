    ...
    <div className="backgroundOrigin1">
      ...
      <div className="containerCarouselOrigin2Beta">
        <div className="textOrigin1">
          ...
          &nbsp; &nbsp; &nbsp;
          <p className="pTextOrigin1">Barrio:</p> La Asunción. Localidad Puente
          Aranda. UPZ Montes.
          <p className="pTextOrigin1">Estrato:</p> 3 &nbsp;&nbsp;
          <p className="pTextOrigin1">Numero de Pisos: </p> 5
          <p className="pTextOrigin1">Numero de Apartamentos:</p> 8 (2 por
          piso). 50 mt2 c/u aprox.
          <p className="pTextOrigin1">
            Parqueaderos Comunales, recepción, salón comunal, Terraza
          </p>
          <p className="pTextOrigin1">Área del lote:</p> &nbsp;150 mt2
          (10*15mts)
        </div>
      </div>
      <div>
        ...
        <ul id="body-Origin1" className="ulOrigin1">
          ...
          <li id="img-container" className="liOrigin1">
            ...
            <label
              htmlFor="img-6"
              className="sb-bignavorigin1"
              title="Previous"
            >
              <ArrowBackIosIcon />
            </label>
            <label htmlFor="img-2" className="sb-bignavorigin1" title="Next">
              <ArrowForwardIosIcon />
            </label>
          </li>
          ...
          <li id="img-container" className="liOrigin1">
            ...
            <label htmlFor="img-3" className="sb-bignavorigin1" title="Next">
              <ArrowForwardIosIcon />
            </label>
          </li>
          ...
          <li id="img-container" className="liOrigin1">
            ...
            <label htmlFor="img-4" className="sb-bignavorigin1" title="Next">
              <ArrowForwardIosIcon />
            </label>
          </li>
          ...
          <li id="img-container" className="liOrigin1">
            ...
            <label htmlFor="img-5" className="sb-bignavorigin1" title="Next">
              <ArrowForwardIosIcon />
            </label>
          </li>
          ...
          <li id="img-container" className="liOrigin1">
            ...
            <label htmlFor="img-6" className="sb-bignavorigin1" title="Next">
              <ArrowForwardIosIcon />
            </label>
          </li>
          ...
          <li id="img-container" className="liOrigin1">
            ...
            <label htmlFor="img-7" className="sb-bignavorigin1" title="Next">
              <ArrowForwardIosIcon />
            </label>
          </li>
          ...
          <li id="img-container" className="liOrigin1">
            ...
            <label htmlFor="img-8" className="sb-bignavorigin1" title="Next">
              <ArrowForwardIosIcon />
            </label>
          </li>
          ...
          <li id="img-container" className="liOrigin1">
            ...
            <label htmlFor="img-1" className="sb-bignavorigin1" title="Next">
              {" "}
              <ArrowForwardIosIcon />{" "}
            </label>
          </li>
