    ...
    <div className="container">
        <div className="carousel">
            ...
            <ul className="carousel__thumbnails">
                <li>
                    <label for="slide-1"><img src={img5} alt=""/></label>
                </li>
                <li>
                    <label for="slide-2"><img src={img4} alt=""/></label>
                </li>
                <li>
                    <label for="slide-3"><img src={img6} alt=""/></label>
                </li>
                <li>
                    <label for="slide-4"><img src={img7} alt=""/></label>
                </li>
                <li>
                    <label for="slide-5"><img src={img8} alt=""/></label>
                </li>
                <li>
                    <label for="slide-6"><img src={img9} alt=""/></label>
                </li>
            </ul>
        </div>
    </div>
